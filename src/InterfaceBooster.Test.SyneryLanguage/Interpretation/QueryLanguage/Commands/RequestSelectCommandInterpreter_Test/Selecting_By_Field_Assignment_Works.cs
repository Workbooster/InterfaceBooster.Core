...
{
    public class Selecting_By_Field_Assignment_Works : QueryLanguageTestBase
    {
...
\QueryLanguageTests\Test = 
    ...
    SELECT TestFirstname = p.Firstname, TestLastname = p.Lastname, TestSize = p.Size, TestWeight = p.Weight;
";
        ...
        public void SELECT_Command_Creates_New_Fields_With_Correct_Name()
        {
            ...
            Assert.AreEqual("TestFirstname", destinationTable.Schema.Fields[0].Name);
            Assert.AreEqual("TestWeight", destinationTable.Schema.Fields[3].Name);
        }
